...
public static class Easings
{
    ...
    /// </summary>
    public static double Linear(double p) => p;

    /// <summary>
    /// Modeled after the parabola y = x^2.
    /// </summary>
    public static double QuadraticEaseIn(double p) => p * p;

    /// <summary>
    /// Modeled after the parabola y = -x^2 + 2x.
    /// </summary>
    public static double QuadraticEaseOut(double p) => -(p * (p - 2));
    ...
    /// </summary>
    public static double CubicEaseIn(double p) => p * p * p;
    ...
    /// </summary>
    public static double QuarticEaseIn(double p) => p * p * p * p;
    ...
    /// </summary>
    public static double QuinticEaseIn(double p) => p * p * p * p * p;
    ...
    /// </summary>
    public static double SineEaseIn(double p) => Math.Sin((p - 1) * HALFPI) + 1;

    /// <summary>
    /// Modeled after quarter-cycle od sine wave (different phase).
    /// </summary>
    public static double SineEaseOut(double p) => Math.Sin(p * HALFPI);

    /// <summary>
    /// Modeled after hald sine wave.
    /// </summary>
    public static double SineEaseInOut(double p) => 0.5d * (1 - Math.Cos(p * PI));

    /// <summary>
    /// Modeled after shifted quadrant IV od unit circle.
    /// </summary>
    public static double CircularEaseIn(double p) => 1 - Math.Sqrt(1 - (p * p));

    /// <summary>
    /// Modeled after shifted quadrant II od unit circle.
    /// </summary>
    public static double CircularEaseOut(double p) => Math.Sqrt((2 - p) * p);
    ...
    /// </summary>
    public static double ExponentialEaseIn(double p) => (p == 0.0d) ? p : Math.Pow(2, 10 * (p - 1));

    /// <summary>
    /// Modeled after the exponential function y = -2^(-10x) + 1.
    /// </summary>
    public static double ExponentialEaseOut(double p) => (p == 1.0d) ? p : 1 - Math.Pow(2, -10 * p);
    ...
    /// </summary>
    public static double ElasticEaseIn(double p) => Math.Sin(13 * HALFPI * p) * Math.Pow(2, 10 * (p - 1));

    /// <summary>
    /// Modeled after the damped sine wave y = sin(-13pi/2*(x + 1))*Math.Pow(2, -10x) + 1.
    /// </summary>
    public static double ElasticEaseOut(double p) => (Math.Sin(-13 * HALFPI * (p + 1)) * Math.Pow(2, -10 * p)) + 1;
    ...
    /// </summary>
    public static double BackEaseIn(double p) => (p * p * p) - (p * Math.Sin(p * PI));
    ...
    public static double BounceEaseIn(double p) => 1 - BounceEaseOut(1 - p);
