...
namespace AuroraControls
{
    ...
    public partial class CalendarPickerHandlerAJ : IDatePickerHandler
    {
        ...
        public CalendarPickerHandlerAJ()
            : base(Mapper, CommandMapper)
        {
        }

        public CalendarPickerHandlerAJ(IPropertyMapper? mapper)
            : base(mapper ?? Mapper, CommandMapper)
        {
        }

        public CalendarPickerHandlerAJ(IPropertyMapper? mapper, CommandMapper? commandMapper)
